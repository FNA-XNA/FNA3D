...
typedef enum
{
	FNA3D_PRESENT_INTERVAL_DEFAULT,
	FNA3D_PRESENT_INTERVAL_ONE,
	FNA3D_PRESENT_INTERVAL_TWO,
	FNA3D_PRESENT_INTERVAL_IMMEDIATE
...
typedef enum
{
	FNA3D_PRIMITIVE_TYPE_TRIANGLE_LIST,
	FNA3D_PRIMITIVE_TYPE_TRIANGLE_STRIP,
	FNA3D_PRIMITIVE_TYPE_LINE_LIST,
	FNA3D_PRIMITIVE_TYPE_LINE_STRIP,
	FNA3D_PRIMITIVE_TYPE_POINT_LIST_EXT
} FNA3D_PrimitiveType;

typedef enum
{
	FNA3D_INDEX_ELEMENT_SIZE_16,
	FNA3D_INDEX_ELEMENT_SIZE_32
} FNA3D_IndexElementSize;

typedef enum
{
	FNA3D_SURFACE_FORMAT_COLOR,
	FNA3D_SURFACE_FORMAT_BGR565,
	FNA3D_SURFACE_FORMAT_BGRA5551,
	FNA3D_SURFACE_FORMAT_BGRA4444,
	FNA3D_SURFACE_FORMAT_DXT1,
	FNA3D_SURFACE_FORMAT_DXT3,
	FNA3D_SURFACE_FORMAT_DXT5,
	FNA3D_SURFACE_FORMAT_NORMALIZED_BYTE2,
	FNA3D_SURFACE_FORMAT_NORMALIZED_BYTE4,
	FNA3D_SURFACE_FORMAT_RGBA1010102,
	FNA3D_SURFACE_FORMAT_RG32,
	FNA3D_SURFACE_FORMAT_RGBA64,
	FNA3D_SURFACE_FORMAT_ALPHA8,
	FNA3D_SURFACE_FORMAT_SINGLE,
	FNA3D_SURFACE_FORMAT_VECTOR2,
	FNA3D_SURFACE_FORMAT_VECTOR4,
	FNA3D_SURFACE_FORMAT_HALF_SINGLE,
	FNA3D_SURFACE_FORMAT_HALF_VECTOR2,
	FNA3D_SURFACE_FORMAT_HALF_VECTOR4,
	FNA3D_SURFACE_FORMAT_HDR_BLENDABLE,
	FNA3D_SURFACE_FORMAT_COLOR_BGRA_EXT
} FNA3D_SurfaceFormat;

typedef enum
{
	FNA3D_DEPTH_FORMAT_NONE,
	FNA3D_DEPTH_FORMAT_D16,
	FNA3D_DEPTH_FORMAT_D24,
	FNA3D_DEPTH_FORMAT_D24S8
} FNA3D_DepthFormat;

typedef enum
{
	FNA3D_CUBE_MAP_FACE_POSITIVE_X,
	FNA3D_CUBE_MAP_FACE_NEGATIVE_X,
	FNA3D_CUBE_MAP_FACE_POSITIVE_Y,
	FNA3D_CUBE_MAP_FACE_NEGATIVE_Y,
	FNA3D_CUBE_MAP_FACE_POSITIVE_Z,
	FNA3D_CUBE_MAP_FACE_NEGATIVE_Z
} FNA3D_CubeMapFace;

typedef enum
{
	FNA3D_BUFFER_USAGE_NONE,
	FNA3D_BUFFER_USAGE_WRITE_ONLY
} FNA3D_BufferUsage;

typedef enum
{
	FNA3D_SET_DATA_OPTIONS_NONE,
	FNA3D_SET_DATA_OPTIONS_DISCARD,
	FNA3D_SET_DATA_OPTIONS_NO_OVERWRITE
...
typedef enum
{
	FNA3D_BLEND_ONE,
	FNA3D_BLEND_ZERO,
	FNA3D_BLEND_SOURCE_COLOR,
	FNA3D_BLEND_INVERSE_SOURCE_COLOR,
	FNA3D_BLEND_SOURCE_ALPHA,
	FNA3D_BLEND_INVERSE_SOURCE_ALPHA,
	FNA3D_BLEND_DESTINATION_COLOR,
	FNA3D_BLEND_INVERSE_DESTINATION_COLOR,
	FNA3D_BLEND_DESTINATION_ALPHA,
	FNA3D_BLEND_INVERSE_DESTINATION_ALPHA,
	FNA3D_BLEND_BLEND_FACTOR,
	FNA3D_BLEND_INVERSE_BLEND_FACTOR,
	FNA3D_BLEND_SOURCE_ALPHA_SATURATION
} FNA3D_Blend;

typedef enum
{
	FNA3D_BLEND_FUNCTION_ADD,
	FNA3D_BLEND_FUNCTION_SUBTRACT,
	FNA3D_BLEND_FUNCTION_REVERSE_SUBTRACT,
	FNA3D_BLEND_FUNCTION_MAX,
	FNA3D_BLEND_FUNCTION_MIN
} FNA3D_BlendFunction;

typedef enum
{
	FNA3D_COLOR_WRITE_CHANNELS_NONE		= 0,
	FNA3D_COLOR_WRITE_CHANNELS_RED		= 1,
	FNA3D_COLOR_WRITE_CHANNELS_GREEN	= 2,
	FNA3D_COLOR_WRITE_CHANNELS_BLUE		= 4,
	FNA3D_COLOR_WRITE_CHANNELS_ALPHA	= 8,
	FNA3D_COLOR_WRITE_CHANNELS_ALL		= 15
} FNA3D_ColorWriteChannels;

typedef enum
{
	FNA3D_STENCIL_OPERATION_KEEP,
	FNA3D_STENCIL_OPERATION_ZERO,
	FNA3D_STENCIL_OPERATION_REPLACE,
	FNA3D_STENCIL_OPERATION_INCREMENT,
	FNA3D_STENCIL_OPERATION_DECREMENT,
	FNA3D_STENCIL_OPERATION_INCREMENT_SATURATION,
	FNA3D_STENCIL_OPERATION_DECREMENT_SATURATION,
	FNA3D_STENCIL_OPERATION_INVERT
} FNA3D_StencilOperation;

typedef enum
{
	FNA3D_COMPARE_FUNCTION_ALWAYS,
	FNA3D_COMPARE_FUNCTION_NEVER,
	FNA3D_COMPARE_FUNCTION_LESS,
	FNA3D_COMPARE_FUNCTION_LESS_EQUAL,
	FNA3D_COMPARE_FUNCTION_EQUAL,
	FNA3D_COMPARE_FUNCTION_GREATER_EQUAL,
	FNA3D_COMPARE_FUNCTION_GREATER,
	FNA3D_COMPARE_FUNCTION_NOT_EQUAL
} FNA3D_CompareFunction;

typedef enum
{
	FNA3D_CULL_MODE_NONE,
	FNA3D_CULL_MODE_CULL_CLOCKWISE_FACE,
	FNA3D_CULL_MODE_CULL_COUNTER_CLOCKWISE_FACE
} FNA3D_CullMode;

typedef enum
{
	FNA3D_FILL_MODE_SOLID,
	FNA3D_FILL_MODE_WIREFRAME
} FNA3D_FillMode;

typedef enum
{
	FNA_TEXTURE_ADDRESS_MODE_WRAP,
	FNA_TEXTURE_ADDRESS_MODE_CLAMP,
	FNA_TEXTURE_ADDRESS_MODE_MIRROR,
} FNA3D_TextureAddressMode;

typedef enum
{
	FNA3D_TEXTURE_FILTER_LINEAR,
	FNA3D_TEXTURE_FILTER_POINT,
	FNA3D_TEXTURE_FILTER_ANISOTROPIC,
	FNA3D_TEXTURE_FILTER_LINEAR_MIP_POINT,
	FNA3D_TEXTURE_FILTER_POINT_MIP_LINEAR,
	FNA3D_TEXTURE_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR,
	FNA3D_TEXTURE_FILTER_MIN_LINEAR_MAG_POINT_MIP_POINT,
	FNA3D_TEXTURE_FILTER_MIN_POINT_MAG_LINEAR_MIP_LINEAR,
	FNA3D_TEXTURE_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT
} FNA3D_TextureFilter;
