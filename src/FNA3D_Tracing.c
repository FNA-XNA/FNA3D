...
static const uint8_t MARK_APPLYVERTEXSHADER		= 59;
static const uint8_t MARK_APPLYPIXELSHADER		= 60;
static const uint8_t MARK_MAPVERTEXSHADERUNIFORMS	= 61;
static const uint8_t MARK_MAPPIXELSHADERUNIFORMS	= 62;
