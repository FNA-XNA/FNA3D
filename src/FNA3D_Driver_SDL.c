...
static void SDLGPU_INTERNAL_SetTextureData(
	...
	copyParams.dstOffset = transferOffset;
	...
	textureCopyParams.bufferOffset = transferOffset;
...
static void SDLGPU_INTERNAL_SetBufferData(
	...
	transferCopyParams.dstOffset = transferOffset;
	...
	uploadParams.srcOffset = transferOffset;
